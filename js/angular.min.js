...
(function (A) {
    ...
    function ne(a, b) {
        var d, c, f = Ka.length;
        for (c = 0; c < f; ++c)
            if (d = Ka[c] + b, y(d = a.getAttribute(d))) return d;
        return null
    }
    ...
    function tb(a) {
        for (var b = a[0], d = a[a.length - 1], c, f = 1; b !== d && (b = b.nextSibling); f++)
            if (c || a[f] !== b) c || (c = F(wa.call(a, 0, f))), c.push(b);
        return c || a
    }
    ...
    function Pc(a, b) {
        ...
        var e = {},
            g = /^\s*directive:\s*([\w-]+)\s+(.*)$/,
            h = /(([\w-]+)(?::([^;]+))?;?)/,
            k = le("ngSrc,ngSrcset,src,srcset"),
            l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/,
            m = /^(on[a-z]+|formaction)$/,
            n = T();
            ...
            y(b) ? (c(b), fb(d, "directiveFactory"), e.hasOwnProperty(b) || (e[b] = [], a.factory(b + "Directive", ["$injector", "$exceptionHandler", function (a, c) {
                ...
                q(e[b], function (e, g) {
                    try {
                        ...
                        B(h) ? h = {
                            compile: fa(h)
                        } : !h.compile && h.link && (h.compile = fa(h.link));
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a,
            ...
            function dc(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        E(f) && (f = f.animVal);
                        if (y(f) && "" !== f)
                            for (; a = h.exec(f);) k = Ca(a[2]), W(b, k, "C", d, e) && (c[k] = R(a[3])), f = f.substr(a.index + a[0].length);
                        break;
                    case Ja:
                        ja(b, a.nodeValue);
                        break;
            ...
            function U(a, b, d, e, f, g, h, k, l) {
                ...
                for (var n = -Number.MAX_VALUE, K = l.newScopeDirective, D = l.controllerDirectives, s = l.newIsolateScopeDirective, O = l.templateDirective, C = l.nonTlbTranscludeDirective,
                    ...
                    if (!ra && (z.replace && (z.templateUrl || z.template) || z.transclude && !z.$$tlb)) {
                        for (v = A + 1; ra = a[v++];)
                            if (ra.transclude && !ra.$$tlb || ra.replace && (ra.templateUrl || ra.template)) {
                                Y = !0;
                                break
                            }
                        ra = !0
                    ...
                    if (v = z.transclude)
                        if (w = !0, z.$$tlb || (Z("transclusion", C, z, I), C = z), "element" === v) pa = !0, n = z.priority, V = I, I = d.$$element = F(aa.$$createComment(J, d[J])), b = I[0], ka(f, wa.call(V, 0), b), V[0].$$parentNode = V[0].parentNode, N = fc(Y, V, e, n, g && g.name, {
                            ...
                            I.empty();
                            N = fc(Y, V, e, void 0, void 0, {
                                needsNewScope: z.$$isolateScope || z.$$newScope
                            });
                            N.$$slots = ha
                        }
                    if (z.template)
                        if (P = !0, Z("template", O, z, I), O = z, v = B(z.template) ? z.template(I, d) : z.template, v = Ea(v), z.replace) {
                            g = z;
            ...
            function ga(a, b, d, e, g, h, k, l) {
                var m = [],
                    ...
                    z = B(t.templateUrl) ? t.templateUrl(b, d) : t.templateUrl,
            ...
            var Da = /^\w/,
                ua = A.document.createElement("div"),
                Fa = J,
                Ga = s,
                za = C,
                ca;
            r.prototype = {
                ...
                $set: function (a, b, d, e) {
                    ...
                    if ("a" === f && ("href" === a || "xlinkHref" ===
                            a) || "img" === f && "src" === a) this[a] = b = I(b, "src" === a);
                    else if ("img" === f && "srcset" === a && u(b)) {
                        for (var f = "", g = R(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(g) ? k : /(,)/, g = g.split(k), k = Math.floor(g.length / 2), l = 0; l < k; l++) var m = 2 * l,
                            f = f + I(R(g[m]), !0),
                            f = f + (" " + R(g[m + 1]));
                        g = R(g[2 * l]).split(/\s/);
                        f += I(R(g[0]), !0);
            ...
            function n(b) {
                ...
                g.headers = function (b) {
                    var c =
                        a.headers,
                        d = Q({}, b.headers),
                        f, g, h, c = Q({}, c.common, c[L(b.method)]);
                    a: for (f in c) {
                        g = L(f);
                        for (h in d)
                            if (L(h) === g) continue a;
                ...
                b = b.then(function (b) {
                    var c =
                        b.headers,
                        d = qd(b.data, pd(c), void 0, b.transformRequest);
    ...
    function qg(a, b, d, c, f) {
        ...
        return function (f, h, k, l, m, n, p, t, C, J) {
            ...
            h = h || a.url();
            if ("jsonp" === L(f)) var M = c.createCallback(h),
                w = e(h, M, function (a, b) {
...
"$sce",
            function (d, c, f) {
                ...
                function k(e, k, p, n) {
                    ...
                    for (var O = [], z = []; D < w;)
                        if (-1 !== (q =
                                e.indexOf(a, D)) && -1 !== (r = e.indexOf(b, q + l))) D !== q && O.push(g(e.substring(D, q))), D = e.substring(q + l, r), K.push(D), pa.push(d(D, M)), D = r + m, z.push(O.length), O.push("");
                        else {
    ...
    function Ed(a, b, d) {
        ...
        function g() {
            for (; !w && u.length;) {
                var a = u.shift();
                a.pur || (a.pur = !0, a = a.value, a = "Possibly unhandled rejection: " + ("function" ===
            ...
            m.prototype = {
                        ...
                        if (!x(e)) {
                            if (E(e))
                                if (ta(e))
                                    ...
                                    if (s > a)
                                        for (b in l++, f) va.call(e, b) || (s--, delete f[b])
                                }
                            else f !== e && (f = e, l++);
                            return l
                        }
                ...
                $digest: function () {
                    ...
                    do {
                        ...
                        a: do {
                            if (p = v.$$watchers)
                                for (t = p.length; t--;) try {
                                    if (a = p[t])
                                        if (m = a.get, (g = m(v)) !== (k = a.last) && !(a.eq ? ma(g, k) : ga(g) && ga(k))) s = !0, c = a, a.last = a.eq ? Fa(g, null) : g, l = a.fn, l(g, k === C ? g : k, v), 5 > q && (A = 4 - q, x[A] || (x[A] = []), x[A].push({
                            ...
                            if (!(p = v.$$watchersCount && v.$$childHead || v !== this && v.$$nextSibling))
                                for (; v !== this && !(p = v.$$nextSibling);) v = v.$parent
                        } while (v = p);
    ...
    function Lf() {
        this.$get = ["$window", "$document", function (a, b) {
            var d = {},
                ...
                f = X((/android (\d+)/.exec(L((a.navigator || {}).userAgent)) || [])[1]),
...
"$q", "$$q", "$exceptionHandler",
    ...
    function Eg(a) {
        var b = 0,
            d, c, f, e, g; - 1 < (c = a.indexOf(Od)) && (a = a.replace(Od, ""));
                ...
                return {
                    ...
                    predicateValues: k.map(function (c) {
                        ...
                        if (null === e) c = "string", e = "null";
                            ...
                            if (B(e.valueOf) && (e = e.valueOf(), d(e))) break a;Ub(e) && (e = e.toString(), d(e))
                        }
                        return {
                            value: e,
                            type: c,
    ...
    function ob(a, b, d, c) {
        return function (f, e, g, h, k, l, m) {
            ...
            xc(f, e, g, h);
            Sa(f, e, g, h, k, l);
            var t = h && h.$options.getOption("timezone"),
                q;
            h.$$parserName = a;
    ...
    var G = Array.isArray,
        ...
        rb = function () {
            ...
            var a, b, d = Ka.length,
                c, f;
            for (b = 0; b < d; ++b)
                if (c = Ka[b], a = A.document.querySelector("[" + c.replace(":", "\\:") + "jq]")) {
    ...
    var Vf = /-([a-z])/g,
        ...
        Zb = /<|&#?\w+;/,
        Wf = /<([\w:-]+)/,
        Xf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
        oa = {
...
"</select>"],
    ...
    q({
        ...
        attr: function (a, b, d) {
            ...
            if (c !== Ja && 2 !== c && 8 !== c && a.getAttribute) {
                var c = L(b),
                    f = Fb[c];
                if (u(d)) null === d || !1 === d && f ? a.removeAttribute(b) : a.setAttribute(b, f ? c : d);
    ...
    var fd = /^((?:x|data)[:\-_])/i,
        ...
        ng = /^\)]\}',?\n/,
        sd = H("$http"),
        Ea = Z.$interpolateMinErr = H("$interpolate");
        ...
        Sg = {
            ...
            search: function (a, b) {
                switch (arguments.length) {
                    ...
                    case 1:
                        if (y(a) ||
                            W(a)) a = a.toString(), this.$$search = Kc(a);
                        else if (E(a)) a = Fa(a, {}), q(a, function (b, c) {
                            null == b && delete a[c]
                        }), this.$$search = a;
    ...
    var Ua = H("$parse"),
        vg = {}.constructor.prototype.valueOf,
        Pb = T();
    q("+ - * / % === !== == != < > <= >= && || ! = |".split(" "), function (a) {
        Pb[a] = !0
    });
        ...
        readString: function (a) {
            ...
            for (var d = "", c = a, f = !1; this.index < this.text.length;) {
                var e = this.text.charAt(this.index),
                    c = c + e;
                if (f) "u" === e ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += Tg[e] || e, f = !1;
                else if ("\\" === e) f = !0;
                else {
                    if (e === a) {
                        this.index++;
    ...
    Cd.prototype = {
        ...
        recurse: function (a, b, d, c, f, e) {
            var g, h, k = this,
                l, m, n;
            c = c || v;
            if (!e && u(a.watchId)) b = b || this.nextId(), this.if_("i", this.lazyAssign(b, this.computedMember("i", a.watchId)), this.lazyRecurse(a, b, d, c, f, !0));
            else switch (a.type) {
                case r.Program:
    ...
    var Ig = {
        ...
        Hg = /((?:[^yMLdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|L+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/,
        Gg = /^-?\d+$/;
    Kd.$inject = ["$locale"];
    var Bg = fa(L),
        Cg = fa(ub);
    ...
    var be = function (a) {
        ...
        Ug = /^[a-z][a-z\d.+-]*:\/*(?:[^:@]+(?::[^@]+)?@)?(?:[^\s:/?#]+|\[[a-f\d:]+])(?::\d+)?(?:\/[^?#]*)?(?:\?[^#]*)?(?:#.*)?$/i,
        Vg = /^(?=.{1,254}$)(?=.{1,64}@)[-!#$%&'*+/0-9=?A-Z^_`a-z{|}~]+(\.[-!#$%&'*+/0-9=?A-Z^_`a-z{|}~]+)*@[A-Za-z0-9]([A-Za-z0-9-]{0,61}[A-Za-z0-9])?(\.[A-Za-z0-9]([A-Za-z0-9-]{0,61}[A-Za-z0-9])?)*$/,
        Kg = /^\s*(-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/,
        ce = /^(\d{4,})-(\d{2})-(\d{2})$/,
    ...
    var ge = {
            ...
            checkbox: function (a, b, d, c, f, e, g, h) {
                var k = Zd(h, a, "ngTrueValue", d.ngTrueValue, !0),
                    l = Zd(h, a, "ngFalseValue",
                        d.ngFalseValue, !1);
                b.on("click", function (a) {
...
"?^^ngModelOptions"],
        ...
        Zg = H("ngOptions"),
        $g = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([$\w][$\w]*)|(?:\(\s*([$\w][$\w]*)\s*,\s*([$\w][$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,
        Ze = ["$compile", "$document", "$parse", function (a, b, d) {
            function c(a,
                b, c) {
            ...
            var f = A.document.createElement("option"),
                e = A.document.createElement("optgroup");
            return {
                restrict: "A",
                terminal: !0,
                ...
                link: {
                    ...
                    post: function (d, h, k, l) {
                        ...
                        var p = l[0],
                            ...
                            v = k.multiple;
                        l = 0;
                        for (var x = h.children(), s = x.length; l < s; l++)
                            if ("" === x[l].value) {
                                p.hasEmptyOption = !0;
                    ...
                    return function (a, d, e, g, l) {
                        ...
                        a.$watchCollection(n, function (e) {
                            ...
                            if (ta(e)) G = e, n = x || w;
                                ...
                                for (L in n = x || A, G = [], e) va.call(e, L) && "$" !== L.charAt(0) && G.push(L);
                            y = G.length;
                            L = Array(y);
                            for (g = 0; g < y; g++)
                                if (B = e === G ? g : G[g], F = e[B], E = n(B, F, g), m[E]) H = m[E], delete m[E], t[E] = H, L[g] = H;
                                else {
                            ...
                            for (g = 0; g < y; g++)
                                if (B = e === G ? g : G[g], F = e[B], H = L[g], H.scope) {
                                    s = r;
